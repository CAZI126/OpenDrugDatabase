...
CORE_EVIDENCE_SCHEMA_VERSION = "odd-core-evidence/2.0.0"
CORE_NO_SELECTION_RULE_VERSION = "odd-core-no-selection/1.0.0"
...
CONNECTOR_VERSION = "dailymed-connector/5.0.0"
...
ENRICHMENT_SNAPSHOT_VERSION = "dailymed-enrichment-snapshot/1.0.0"
ENRICHMENT_EXTRACTOR_VERSION = "dailymed-candidate-evidence-extractor/1.0.0"
ENRICHMENT_RULE_VERSION = "dailymed-candidate-evidence-rules/1.0.0"
ENRICHMENT_REPORT_VERSION = "odd-enrichment-report/1.0.0"
ENRICHMENT_SELECTION_RULE_VERSION = "dailymed-top10-enriched-selection/1.0.0"
LIVE_OBSERVATION_MODE = "LIVE"
UTILIZATION_LIST_SCHEMA_VERSION = "odd-utilization-list/1.0.0"
DAILYMED_QUERY_RESULTS_SCOPE = "DAILYMED_CURRENT_HUMAN_RX_GENERIC_QUERY_RESULTS"
VALIDATION_LABEL_SCOPE = "VALIDATION_LABEL_EXACT_LEXICAL_SINGLE_ACTIVE"
REGULATORY_ROLE_DISCOVERY_SCOPE = "REGULATORY_ROLE_APPLICATION_FAMILY_DISCOVERY"
TECHNICAL_VALIDATION_SAMPLE_SCOPE = "TECHNICAL_VALIDATION_SPL_SAMPLE"
SELECTION_SCOPE = VALIDATION_LABEL_SCOPE
