...
- **Fixed identity:** `97935fd9-1d4a-43b6-a5d9-de994591187b` version `48`
- **Gold file:** `docs/step1_gold/S1-09_gabapentin.md` (`d0560701181cf51a1ebb16f736868f9e56100f6f02464b886a1986947d500e09`)
- **MCP case file:** `docs/step1_mcp_run/S1-09_gabapentin.md` (`3a285807821e257985ed3e9bc54ebb0b1a6fcabefc587f404cde0610f75c4543`)
- **MCP raw output:** `docs/step1_mcp_run/raw/S1-09_gabapentin.json` (`a0ea2b555a2cd48c4635f86a0be26bf59246195ad1bbd5cc44bcce1943685132`)
...
- find_documents: 1.012 s | index: 0.849 s | slice: 0.734 s | verify: 1.132 s
- total automated: 6.894 s
- slice requested `['42229-5']`, not found `[]`, unexpected `[]`
...
| --- | --- | --- |
| Dosage adjustment is recommended for patients 12 years and older with renal impairment or on hemodialysis. | MET | MCP: same. |
| The table is titled TABLE 1 and is keyed on creatinine clearance in mL/min. | MET | MCP: same. |
| CrCl at or above 60: total daily dose 900 to 3600 mg, dosed TID. | MET | MCP: same. |
| CrCl above 30 to 59: total daily dose 400 to 1400 mg, dosed BID. | MET | MCP: same. |

**MCP statements beyond the gold claims:**

- CrCl above 15 to 29: 200 to 700 mg/day, dosed QD. — supported by the slice text: '>15 to 29 200 to 700 200 QD 300 QD 400 QD 500 QD 700 QD'

## Provisional verdict: PASS

Gold verdict was **SUPPORTED**.

Every gold claim is answered from section 2.3 at the same locator. The MCP answer states one band the gold did not, and that band is present verbatim in the returned slice text, so it is supported rather than added. The slice carried the whole table, including the <15 and post-hemodialysis rows.
